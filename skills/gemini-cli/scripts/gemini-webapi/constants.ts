...
export class Model {
  ...
  static readonly G_3_5_FLASH = new Model(
    'gemini-3.5-flash',
    {},
    false,
  );
  static readonly G_3_5_PRO = new Model(
    'gemini-3.5-pro',
    {},
    false,
  );
  static readonly G_3_5_PRO_THINKING = new Model(
  ...
  static readonly G_3_1_FLASH_LITE = new Model(
  ...
  static from_name(name: string): Model {
    for (const model of [Model.UNSPECIFIED, Model.G_3_5_FLASH, Model.G_3_5_PRO, Model.G_3_5_PRO_THINKING, Model.G_3_1_PRO_PREVIEW, Model.G_3_1_FLASH_LITE]) {
      if (model.model_name === name) return model;
    }

    throw new Error(
      `Unknown model name: ${name}. Available models: ${[Model.UNSPECIFIED, Model.G_3_5_FLASH, Model.G_3_5_PRO, Model.G_3_5_PRO_THINKING, Model.G_3_1_PRO_PREVIEW, Model.G_3_1_FLASH_LITE]
        .map((m) => m.model_name)
        .join(', ')}`,
    );
  }
